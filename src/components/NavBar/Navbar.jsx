  ...
  return (
    <div>
      <div className="fixed w-full h-[80px] flex justify-between items-center px-4 bg-gray-900 text-gray-300 z-50">
        ...
        {/* Mobile Menu */}
        <ul
          className={`fixed top-0 left-0 w-full h-screen bg-gray-900 flex flex-col justify-center items-center transition-transform duration-300 ${
            nav ? 'translate-x-0' : '-translate-x-full'
          }`}
        >
          <li className="py-6 text-3xl">
            <Link onClick={handleClick} to="game" smooth={true} duration={100} offset={-80} className="text-white">
              Play Game
            </Link>
          </li>
          <li className="py-6 text-3xl">
            <Link onClick={handleClick} to="home" smooth={true} duration={100} offset={-80} className="text-white">
              Home
            </Link>
          </li>
          <li className="py-6 text-3xl">
            <Link onClick={handleClick} to="about" smooth={true} duration={100} offset={-80} className="text-white">
              About
            </Link>
          </li>
          <li className="py-6 text-3xl">
            <Link onClick={handleClick} to="projects" smooth={true} duration={100} offset={-80} className="text-white">
              Projects
            </Link>
          </li>
          <li className="py-6 text-3xl">
            <Link onClick={handleClick} to="contact" smooth={true} duration={100} offset={-80} className="text-white">
              Contact
            </Link>
          </li>
          <li className="mt-8">
      ...
      <ScrollPercentage style={{ width: `${scrollPercentage}%` }} />
    </div>
  );
};
